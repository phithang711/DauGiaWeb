...
CREATE TABLE `bid` (
  ...
  `isAutobid` int(11) DEFAULT '0',
  `maxAutobid` int(11) DEFAULT NULL,
  PRIMARY KEY (`bid_id`),
...
INSERT INTO `bid` VALUES (1,1,11,'2019-12-22 14:30:20',750,0,NULL),(2,2,12,'2019-12-20 11:22:00',760,0,NULL),(3,3,13,'2019-12-20 11:30:30',760,0,NULL),(4,4,14,'2019-12-01 05:00:00',750,0,NULL),(5,5,15,'2019-12-02 06:12:00',765,0,NULL),(6,6,16,'2019-12-02 06:57:00',765,0,NULL),(7,7,17,'2019-12-05 13:25:23',700,0,NULL),(8,8,18,'2019-11-24 15:47:46',200,0,NULL),(9,9,19,'2019-11-29 18:47:30',800,0,NULL),(10,10,11,'2019-12-15 08:12:48',800,0,NULL),(11,11,12,'2019-12-22 14:30:20',750,0,NULL),(12,12,12,'2019-12-20 11:22:00',750,0,NULL),(13,13,13,'2019-12-20 11:30:30',400,0,NULL),(14,14,13,'2019-12-01 05:00:00',400,0,NULL),(15,15,14,'2019-12-02 06:12:00',400,0,NULL),(16,16,14,'2019-12-02 06:57:00',500,0,NULL),(17,17,15,'2019-12-05 13:25:23',450,0,NULL),(18,18,15,'2019-11-24 15:47:46',100,0,NULL),(19,19,16,'2019-11-29 18:47:30',100,0,NULL),(20,20,16,'2019-12-15 08:12:48',1500,0,NULL),(21,21,17,'2019-12-16 05:00:00',760,0,NULL),(22,21,17,'2019-12-17 18:00:00',770,0,NULL),(23,21,18,'2019-12-18 13:20:10',775,0,NULL),(24,21,18,'2019-12-18 18:00:00',780,0,NULL),(25,22,19,'2019-12-20 06:00:00',130,0,NULL),(26,22,19,'2019-12-21 05:00:00',140,0,NULL),(27,23,11,'2019-12-22 14:30:20',270,0,NULL),(28,24,12,'2019-12-20 11:22:00',250,0,NULL),(29,24,13,'2019-12-20 11:30:30',260,0,NULL),(30,25,14,'2019-12-01 05:00:00',100,0,NULL),(31,25,15,'2019-12-02 06:12:00',150,0,NULL),(32,25,16,'2019-12-02 06:57:00',170,0,NULL),(33,25,17,'2019-12-05 13:25:23',190,0,NULL),(34,26,18,'2019-11-24 15:47:46',550,0,NULL),(35,26,18,'2019-11-29 18:47:30',565,0,NULL),(36,26,19,'2019-12-15 08:12:48',580,0,NULL),(37,27,11,'2019-12-02 12:31:51',150,0,NULL),(38,27,11,'2019-12-05 12:58:59',180,0,NULL),(39,27,12,'2019-12-05 15:12:31',220,0,NULL),(40,27,12,'2019-12-06 13:32:21',300,0,NULL),(41,28,13,'2019-12-21 21:45:00',350,0,NULL),(42,28,13,'2019-12-22 22:56:48',380,0,NULL),(43,29,14,'2019-12-01 05:12:23',750,0,NULL),(44,29,14,'2019-12-01 06:00:00',755,0,NULL),(45,29,15,'2019-12-03 21:41:21',765,0,NULL),(46,30,15,'2019-12-12 14:12:42',750,0,NULL),(47,30,16,'2019-12-12 16:12:45',760,0,NULL),(48,30,16,'2019-12-13 04:12:15',785,0,NULL),(49,30,17,'2019-12-14 06:19:20',795,0,NULL),(50,30,17,'2019-12-14 09:19:20',820,0,NULL),(51,21,9,'2020-01-09 10:10:18',810,0,NULL),(52,25,9,'2020-01-09 10:44:55',250,0,NULL),(53,21,22,'2020-01-09 11:43:27',870,0,NULL);
...
INSERT INTO `category` VALUES ('laptop'),('phone');
...
--
-- Table structure for table `wonbidlist`
--

DROP TABLE IF EXISTS `wonbidlist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wonbidlist` (
  `ProductID` int(11) DEFAULT NULL,
  `UserWonID` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `wonbidlist`
--

LOCK TABLES `wonbidlist` WRITE;
/*!40000 ALTER TABLE `wonbidlist` DISABLE KEYS */;
INSERT INTO `wonbidlist` VALUES (1,11),(2,12),(3,13),(4,14),(5,15),(6,16),(7,17),(8,18),(9,19),(10,11),(11,12),(12,12),(13,13),(14,13),(15,14),(16,14),(17,15),(18,15),(19,16),(20,16);
/*!40000 ALTER TABLE `wonbidlist` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-01-09 17:40:33
