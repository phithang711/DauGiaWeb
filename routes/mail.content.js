module.exports = {
    getMailContent: function(user, price, productName, merchantName, content) {
        return `<div class=""><div class="aHl"></div><div id=":38" tabindex="-1"></div><div id=":cr" class="ii gt"><div id=":37" class="a3s aXjCH "><div class="adM">	
